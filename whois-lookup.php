...
<div class="span9">
	...
	<div class="row" style="margin-left: 0px;">
		<div class="span12">
			<div class="well">
				<form action="whois-lookup.php" method="POST" style="margin: 0px;">
					<input type="text" class="span9" name="url" value="<?=$headers->PostField('url');?>" placeholder="example.com" style="padding: 21px; font-size: 15px; margin: 0px;">
